...
<head>
<title>Esperanto-Vortaro (Leono Ma)</title>
...
function klaku_vorto(v)
{
 ...
 call_ajax_text_post("../ekma/tiru-enhavon.php", "vorto=" + encodeURI(v),
  function(r) {
    E("rezulto").innerHTML = r;
    try { localStorage[v] = r; } catch (e) { /* alert("b:" + e); */ }
  }
...
<table class=frm>
 ...
 <tr>
  ...
  <td class=tdButton align=right width=60><img id=Search src="./iui/Search.png" width=58 height=30></td>
 </tr>
</table>

<span id="rezulto" class=klarigo style="font-size:14pt">
  Bonvenon al Esperanto vortaro. (Korea, Angla)<br>
  <br>
  마영태 선생님의 에스페란토 사전입니다.<br>
  삿갓글자는 'x' 또는 '^'를 이용하세요.
  <br>
  <br>
  ...
  Baza Radikaro Oficiala(BRO)를 근거해서 부여한 것입니다.
   [GX] Oficiala Aldono<br>
  <br>
  G5 까지 580여 단어, G6 까지 990여 단어,<br>
G7 까지 1,200여 단어, G8 까지 1,700여 단어,<br>
G9 까지 2,500여 단어, GX 까지 3,900여 단어.<br>
한/에 전체 53,000여 단어 수준.

    <p>
    이 사전의 저작권은 마영태 선생님에게 있습니다.<br>
    사전의 저작물에 대한 활용을 하고 싶으신 분들은 마영태 선생님에게
    전화 또는 메일로 문의를 하시기 바랍니다.
    </p>
