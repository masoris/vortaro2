...
<head>
<title>Esperanto-Vortaro (Japana)</title>
...
function klaku_vorto(v)
{
 ...
 call_ajax_text_post("../ek/tiru-enhavon-4.php", "vorto=" + encodeURI(v),
  function(r) { E("rezulto").innerHTML = r; }
 );
 first = 1;
}
...
<table class=tb>
 <tr><td class=tbC>Esperanto-Vortaro (Japana)</td></tr>
</table>

<table class=frm>
 <tr>
  <td width=50><nobr>Esp-Jap:</nobr></td>
  <td>
